...
export class Menu extends React.Component{
    ...
    goToHome = () => {
        Alert.alert('Navigates To Home Page');
    }
    goToSearch = () => {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.buttonRow}>
                    ...
                    <TouchableOpacity style={styles.buttonStyles} onPress={this.goToSearch}>
                ...
                <View style={styles.buttonRow}>
                    ...
                    <TouchableOpacity style={styles.buttonStyles} onPress={this.showLoggedOut}>
                ...
                <View style={styles.buttonRow}>
                    <TouchableOpacity style={styles.bottomButton} onPress={this.goToWriteReview}>
